...
Pod::Spec.new do |s|
  ...
  s.source                 = source
  s.source_files           = "#{version}/react-native/ReactCommon/cxxreact/*.{cpp,h}"
  s.exclude_files          = "#{version}/react-native/ReactCommon/cxxreact/SampleCxxModule.*"
  ...
  s.header_dir             = "#{version}/react-native/ReactCommon/cxxreact/"
